...
public class ClienteDAO implements IDAO<ClienteModel>{
    ...
    public String[] readComboBox() {
        try{
            ...
            String sqlCount = "select count(id) as qtde from projeto_integrador_vi.cliente where ativo = 'S';";
            ...
            String sql = "select id||' - '||nome as info from projeto_integrador_vi.cliente where ativo = 'S' order by id;";
