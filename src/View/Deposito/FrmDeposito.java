...
public class FrmDeposito extends javax.swing.JFrame {
    ...
    private void populateTable(){
        ...
        String[][] data = new DepositoDAO().read(fieldFilter.getText());
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(fieldDescricao, javax.swing.GroupLayout.DEFAULT_SIZE, 545, Short.MAX_VALUE))))
                .addContainerGap())
        );
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        if(fieldAreValid){
            ...
            if(idDeposito == 0){
                ...
                boolean sucesso = dao.create(depositoModel);
                ...
                depositoModel.setId(idDeposito);
                
                boolean sucesso = dao.update(depositoModel);
                
                idDeposito = 0;
                
                if(sucesso){
                    JOptionPane.showMessageDialog(null, "Sucesso ao editar depósito", "SUCESSO", 1);
                    ...
                    JOptionPane.showMessageDialog(null, "Erro ao editar depósito", "ERRO", 2);
                }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        idDeposito = Integer.parseInt(jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString());
        
        fieldDescricao.setText(jTable1.getValueAt(jTable1.getSelectedRow(), 1).toString());
        fieldEndereco.setText(jTable1.getValueAt(jTable1.getSelectedRow(), 2).toString());
